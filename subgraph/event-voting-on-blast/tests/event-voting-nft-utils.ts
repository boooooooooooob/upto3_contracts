...
import {
  ...
  Upgraded,
  Voted
} from "../generated/EventVotingNFT/EventVotingNFT"
...
export function createEventCreatedEvent(
  ...
  eventCreatedEvent.parameters.push(
    new ethereum.EventParam("who", ethereum.Value.fromString(who))
  )
  eventCreatedEvent.parameters.push(
    new ethereum.EventParam("what", ethereum.Value.fromString(what))
  )
  eventCreatedEvent.parameters.push(
